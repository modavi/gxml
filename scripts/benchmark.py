...
# run_benchmark is defined below in this file (consolidated from runner.py)
...
# main() function moved to end of file after run_benchmark is defined
...
def _get_project_root() -> str:
    ...
    # This file is at scripts/benchmark.py
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python scripts/benchmark.py tests/performance/xml/7Panels.xml
    python scripts/benchmark.py my_layout.gxml --iterations 10
    python scripts/benchmark.py layout.xml --backend c --no-hierarchy
    python scripts/benchmark.py tests/performance/xml/200Panels.xml --overhead
    python scripts/benchmark.py tests/performance/xml/200Panels.xml --sampling
        """
    )
