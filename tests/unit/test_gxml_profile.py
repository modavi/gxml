...
from gxml.profiling import (
    enable_profiling, is_profiling_enabled, reset_profile,
    get_profile_results, perf_marker, profile
)

# All these should work without error
enable_profiling(True)
assert is_profiling_enabled() == False  # Always False when compiled out
reset_profile()
...
class TestProfilingFunctionality:
    ...
    def test_enable_disable_profiling(self):
        ...
        from gxml.profiling import enable_profiling, is_profiling_enabled, reset_profile
    ...
    def test_perf_marker_records_timing(self):
        ...
        from gxml.profiling import (
            enable_profiling, reset_profile, perf_marker, get_profile_results
        )
        import time
    ...
    def test_profile_decorator_records_timing(self):
        ...
        from gxml.profiling import (
            enable_profiling, reset_profile, profile, get_profile_results
        )
        import time
